...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/Morgoliath/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/Morgoliath/capstone/password", WithDecryption=True)
...
AWS_STORAGE_BUCKET_NAME = 'aws-capstone-aslan-blog' # please enter your s3 bucket name
